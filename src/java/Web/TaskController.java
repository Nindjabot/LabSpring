...
public class TaskController {
    ...
    public String addTask(@RequestParam("name") String name, @RequestParam("description") String description, @RequestParam("due_date") @DateTimeFormat(pattern = "dd-MM-yyyy") Date dueDate) {
    Task task = new Task();
    task.setName(name);
